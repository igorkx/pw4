    ...
    <body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
                ...
                <a href="editNews.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Alterar Noticia</a>
                <a href="delNews.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Deletar Noticia</a>
                <a href="cadastrarNoticia.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Cadastrar Noticias</a>
                <a href="alterAutor.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Alterar Autor</a>
                <a href="delAutor.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Deletar Autor</a>
                <a href="cadastroUsuario.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Cadastrar Autor</a>
