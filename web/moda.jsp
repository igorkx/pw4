    ...
    <body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
                ...
                <a href="moda.jsp" class="w3-bar-item w3-button w3-theme-l1">Moda</a>
        ...
        <%
            ...
            try {
                ...
                ResultSet rs = stm.executeQuery("SELECT titulo, texto, imagem FROM noticia WHERE categoria = 'moda';");
